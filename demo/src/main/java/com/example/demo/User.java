...
public class User {
	...
	// Getters and Setters are necessary to modify and set DB Values
	...
	// Represents autogenerated values in DB  
	public int getId() {
		return id;
	}
	...
	//Necessary implementation of this constructor if autowired anotation used	
	public User() {
	}
